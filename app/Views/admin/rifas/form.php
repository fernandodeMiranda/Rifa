    ...
    <form method="POST" action="/admin/rifas" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="numero_inicial" value="0" required class="w-full border rounded px-3 py-2">
            </div>
            <div>
                <label class="block text-sm mb-1">Número final</label>
                <input type="number" name="numero_final" required class="w-full border rounded px-3 py-2">
            </div>
        </div>
        <div>
            <label class="block text-sm mb-1">Preço por número (R$)</label>
            <input type="number" step="0.01" name="preco_numero" required class="w-full border rounded px-3 py-2">
        </div>
        <div>
            <label class="block text-sm mb-1">Data do sorteio</label>
            <input type="datetime-local" name="data_sorteio" required class="w-full border rounded px-3 py-2">
        </div>
